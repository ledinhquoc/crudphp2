	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="https://qcshop.vn/"></a>
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href=" <?php echo e(BASE_URL.'logout'); ?> "><svg class="glyph stroked cancel">
...
</html><?php /**PATH C:\xampp\htdocs\php2\app\views/layouts/main.blade.php ENDPATH**/ ?>